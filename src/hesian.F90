...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  real(wp)                :: position(0:NGdof)

  LOGICAL             :: LComputeDerivatives, LComputeAxis

  real(wp)                :: force(0:NGdof), gradient(0:NGdof)

  real(wp)                :: xx(0:NGdof,-2:2), ff(0:NGdof,-2:2), df(1:NGdof)!, deriv

  integer             :: vvol, idof, ii, mi, ni, irz, issym, isymdiff, lvol, ieval(1:1), igdof, ifd
  real(wp)                :: oldEnergy(-2:2), error, cpul

  real(wp)                :: oldBB(1:Mvol,-2:2), oBBdRZ(1:Mvol,0:1,1:LGdof), ohessian(1:NGdof,1:NGdof)

  real(wp)                :: oRbc(1:mn,0:Mvol), oZbs(1:mn,0:Mvol), oRbs(1:mn,0:Mvol), oZbc(1:mn,0:Mvol), determinant
...
!  INTEGER            :: lvol, jvol, ivol, innout, imn, irz, jmn, jrz, tdoc, tdof, ilocaldof, jlocaldof ! for parallel / series construction of Hessian;
  ...
  real(wp)                :: evalr(1:NGdof), evali(1:NGdof)
!  REAL                :: evecr(1:NGdof,1:NGdof), eveci(1:NGdof,1:NGdof)
  real(wp)                :: evecr(1:NGdof,1:NGdof), eveci(1:NGdof,1:NGdof),revecr(1:NGdof,1:2*NGdof), evecl(1:NGdof,1:NGdof)
  real(wp)                :: work(1:4*NGdof) ! for construction of evalues/evectors;
  character           :: JOB
  ...
  character           :: equed
  real(wp)                :: perturbation(1:LGdof)
  real(wp)                :: rhs(1:NGdof), solution(0:NGdof)
  real(wp)                :: rworka(1:NGdof), rworkb(1:NGdof), AA(1:NGdof,1:NGdof)
  real(wp)                :: Rdgesvx(1:NGdof), Cdgesvx(1:NGdof), AF(1:NGdof,1:NGdof), work4(1:4*NGdof), rcond, ferr, berr, sgn
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  oldBB(1:Mvol,0) = lBBintegral(1:Mvol)
   ...
   if( .not.allocated(dBBdRZ) ) then
     write(6,'("hesian :      fatal : myid=",i3," ; .not.allocated(dBBdRZ) ; need to revise logic in preset where dBBdRZ is allocated ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : .not.allocated(dBBdRZ) : need to revise logic in preset where dBBdRZ is allocated  ;"
    endif
  ...
  oZbc(1:mn,0:Mvol) = iZbc(1:mn,0:Mvol)
   ...
   if( Lfreebound.eq.1 ) then
     write(6,'("hesian :      fatal : myid=",i3," ; Lfreebound.eq.1 ; this routine needs attention ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : Lfreebound.eq.1 : this routine needs attention  ;"
    endif
 ...
 ! re-calculate Beltrami fields;
   ...
   if( Igeometry.eq.1 ) then
     write(6,'("hesian :      fatal : myid=",i3," ; Igeometry.eq.1 ; Cartesian geometry does not need regularization factor ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : Igeometry.eq.1 : Cartesian geometry does not need regularization factor  ;"
    endif
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  if(LHmatrix .and. Igeometry.eq.2) then
   ...
   allocate( HdFFdRZ (1:LGdof,0:1,1:LGdof,0:1,1:Mvol), stat=astat )
   HdFFdRZ (1:LGdof,0:1,1:LGdof,0:1,1:Mvol) = zero
   ...
   allocate( denergydrr(1:LGdof,1:Mvol,0:1,1:LGdof,0:1), stat=astat )
   denergydrr(1:LGdof,1:Mvol,0:1,1:LGdof,0:1) = zero

  !SALLOCATE( denergydrz, (1:LGdof,1:Mvol,0:1,1:LGdof,0:1), zero)

   allocate( denergydzr(1:LGdof,1:Mvol,0:1,1:LGdof,0:1), stat=astat )
   denergydzr(1:LGdof,1:Mvol,0:1,1:LGdof,0:1) = zero
...
if( LocalConstraint ) then
   ...
   allocate( dmupfdx(1:Mvol, 1:Mvol-1, 1:2, 1:LGdof, 0:1), stat=astat )
   dmupfdx(1:Mvol, 1:Mvol-1, 1:2, 1:LGdof, 0:1) = zero

endif


   allocate( hessian2D(1:NGdof,1:NGdof), stat=astat )
   hessian2D(1:NGdof,1:NGdof) = zero


   allocate( dessian2D(1:NGdof,1:LGdof), stat=astat )
   dessian2D(1:NGdof,1:LGdof) = zero
 ! part of hessian that depends on boundary variations; 18 Dec 14;
  ...
  LComputeAxis = .false.
   ...
   cpuo = MPI_WTIME()
 ! calculate force-imbalance & hessian;
...
!   write(lunit+myid,'("hesian : ", 10x ," : ")')
   ...
   cput = MPI_WTIME()
   Thesian = Thesian + ( cput-cpuo )
   call dforce( NGdof, xx(0:NGdof,isymdiff), ff(0:NGdof,isymdiff), LComputeDerivatives, LComputeAxis)
   cpuo = MPI_WTIME()
 ! force-imbalance;
   ...
   if( tdoc.lt.              1 ) then
     write(6,'("hesian :      fatal : myid=",i3," ; tdoc.lt.              1 ; needs attention ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : tdoc.lt.              1 : needs attention  ;"
    endif


   if( tdoc.gt.NGdof ) then
     write(6,'("hesian :      fatal : myid=",i3," ; tdoc.gt.NGdof ; needs attention ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : tdoc.gt.NGdof : needs attention  ;"
    endif
...
1001   format("hesian : ",f10.2," : myid=",i3, &
   ...
   cput = MPI_WTIME()
   Thesian = Thesian + ( cput-cpuo )
   call packxi( NGdof, position(0:NGdof), Mvol, mn, iRbc(1:mn,0:Mvol), iZbs(1:mn,0:Mvol), iRbs(1:mn,0:Mvol), iZbc(1:mn,0:Mvol), pack, .false., LComputeAxis )
   cpuo = MPI_WTIME()
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  if( LHmatrix ) then
   ...
   if( myid.eq.0 ) then ; cput = MPI_WTIME() ; write(ounit,'("hesian : ",f10.2," : LHmatrix="L2" ;")')cput-cpus, LHmatrix ;
...
! if( myid.eq.0 .and. ( LHevalues .or. LHevectors ) ) then ! the call to dforce below requires all cpus; 04 Dec 14;
  if(                 ( LHevalues .or. LHevectors ) ) then
   ...
   if( myid.eq.0 ) then ; cput = MPI_WTIME() ; write(ounit,'("hesian : ",f10.2," : LHevalues="L2" , LHevectors="L2" ;")')cput-cpus, LHevalues, LHevectors
   endif
...
! the following will be replaced when perturbation is supplied as input; 18 Dec 14;
   ...
   if( Igeometry.gt.2 .or. NOTstellsym ) then
     write(6,'("hesian :      fatal : myid=",i3," ; Igeometry.gt.2 .or. NOTstellsym ; only for stellarator-symmetric cylindrical ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : Igeometry.gt.2 .or. NOTstellsym : only for stellarator-symmetric cylindrical  ;"
    endif
...
! the   above   will be replaced when perturbation is supplied as input; 18 Dec 14;
   ...
   if( sqrt(sum( perturbation(1:LGdof)**2 ) ).lt.vsmall ) then
    ...
    case default ;
   if( .true. ) then
     write(6,'("hesian :      fatal : myid=",i3," ; .true. ; illegal ifail returned from dgesvx ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : .true. : illegal ifail returned from dgesvx  ;"
    endif
   ...
   cput = MPI_WTIME()
   Thesian = Thesian + ( cput-cpuo )
   call packxi( NGdof,     solution(0:NGdof), Mvol, mn, dRbc(1:mn,0:Mvol), dZbs(1:mn,0:Mvol), dRbs(1:mn,0:Mvol), dZbc(1:mn,0:Mvol), pack, .false., LComputeAxis )
   cpuo = MPI_WTIME()
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  if( myid.eq.0 ) then
   ...
   case default ;
   if( .true. ) then
     write(6,'("hesian :      fatal : myid=",i3," ; .true. ; illegal ifail returned from dgetrf ;")') myid
     call MPI_ABORT( MPI_COMM_SPEC, 1, ierr )
     stop "hesian : .true. : illegal ifail returned from dgetrf  ;"
    endif
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  if(LHmatrix .and. Igeometry.eq.2) then
   ...
   deallocate(denergydrr,stat=astat)

  !DALLOCATE(denergydrz)

   deallocate(denergydzr,stat=astat)
  ...
  Lhessian3Dallocated=.false.
   ...
   deallocate(hessian2D,stat=astat)

  write(ounit,*) 5656


   deallocate(dessian2D,stat=astat)
